...
A `setup.RData` file is available within the Scripts folder of the GitHub repository. Here, the workspace image after pre-processing is loaded to facilitate the construction of plots.
